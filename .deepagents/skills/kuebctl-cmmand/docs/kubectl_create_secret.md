...
* [kubectl create secret docker-registry](kubectl_create_secret_docker-registry.md)	 - 创建一个给 Docker registry 使用的 Secret
...
* [kubectl create secret tls](kubectl_create_secret_tls.md)	 - 创建一个 TLS secret
