...
```
      ...
      --docker-email string            用于 Docker 镜像库的邮件地址
      --docker-password string         用于 Docker 镜像库身份验证的密码
      --docker-server string           Docker 镜像库的服务器位置 (default "https://index.docker.io/v1/")
      --docker-username string         用于 Docker 镜像库身份验证的用户名
